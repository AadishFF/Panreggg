...
# Set Your Bot Token
TOKEN = 'MTQwODMwNTgwMjY5NTE0NzU5MQ.GBTBoQ.DbuAqiEzt57UdDdziOW0hVSv6iG-Aio8Buje2g'
...
async def create_server_task(interaction):
    ...
    if ssh_session_line:
        ...
        await interaction.followup.send(embed=discord.Embed(description="### Instance created successfully. Check your DMs for deta
